...
BEGIN
    ...
    SELECT (
        ...
        FROM unnest(ARRAY['WHEELS_ON_HOUR', 'WHEELS_OFF_HOUR']) AS x
    ...
    SELECT (
        ...
        FROM unnest(ARRAY['WHEELS_ON_HOUR', 'WHEELS_OFF_HOUR']) AS x--edit here
    )
    INTO tmp_array2;
    ...
    FOR i in 1..5 LOOP
        ...
        continuous_columns_null := ARRAY['WHEELS_ON_HOUR', 'WHEELS_OFF_HOUR'];
