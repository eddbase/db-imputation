...
BEGIN
    ...
    SELECT (
        ...
        FROM unnest(ARRAY['WHEELS_ON_HOUR', 'WHEELS_OFF_HOUR', 'TAXI_OUT', 'TAXI_IN']) AS x
    ...
    SELECT (
        ...
        FROM unnest(ARRAY['WHEELS_ON_HOUR', 'WHEELS_OFF_HOUR', 'TAXI_OUT', 'TAXI_IN']) AS x--edit here
    )
    INTO tmp_array2;
    ...
    FOR i in 1..5 LOOP
        ...
        continuous_columns_null := ARRAY['WHEELS_ON_HOUR', 'WHEELS_OFF_HOUR', 'TAXI_OUT', 'TAXI_IN'];
