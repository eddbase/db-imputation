...
def load_soil():
    ...
    for fips in tqdm(score_df.index.get_level_values(0).unique()):
        ...
        X = fips_df[time_data_cols].values#get temporal data of every fips
        y = fips_df["score"].values
        X_s = soil_df[soil_df["fips"] == fips][static_data_cols].values[0]#get static data of that fips
    ...
    y_true = round_and_intify(y_target_valid.flatten())
    y_pred = round_and_intify(y_pred_valid.flatten())
